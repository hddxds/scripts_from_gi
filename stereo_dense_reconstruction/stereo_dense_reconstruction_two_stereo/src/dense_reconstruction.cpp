...
Mat XR, XT, Q, P1, P2,SE3_1,SE3_2; //SE3_1,SE3_2 for stereo cam1 and stereo cam2
...
void publishPointCloud(Mat& img_left, Mat& dmap,Mat& SE3) {
  if (debug == 1) {
  ...
  for (int i = 0; i < img_left.cols; i++) {
    for (int j = 0; j < img_left.rows; j++) {
      ...
      Mat point3d_cam = Mat(4, 1, CV_64FC1);
      point3d_cam.at<double>(0,0) = X;
      point3d_cam.at<double>(1,0) = Y;
      point3d_cam.at<double>(2,0) = Z;
      point3d_cam.at<double>(3,0) = 1.0;
      ...
      //cout<<"SE3.type:"<<SE3.type()<<";point3d_cam.type:"<<point3d_cam.type()<<endl;
      Mat point3d_robot = SE3*point3d_cam;
      Mat point3d_robot3 = Mat(3,1,CV_64FC1);
      point3d_robot3.at<double>(0,0) = point3d_robot.at<double>(0,0);
      point3d_robot3.at<double>(1,0) = point3d_robot.at<double>(1,0);
      point3d_robot3.at<double>(2,0) = point3d_robot.at<double>(2,0);


      points.push_back(Point3d(point3d_robot3));
...
void imgCallback(const sensor_msgs::ImageConstPtr& msg_left, const sensor_msgs::ImageConstPtr& msg_right,Mat& SE3) {
  ...
  //cout<<"step3"<<endl;
  //cout << "chan of img_left:"<<img_left.channels()<<"; chan of img_left_color:"<<img_left_color.channels()<<endl;
  //cout<<"dtype of dmap:"<<dmap.type()<<endl;
  publishPointCloud(img_left_color, dmap,SE3);
  //cout<<"step4"<<endl;
...
int main(int argc, char** argv) {
  ...
  //stereo_camera_1.
  SE3_1 = Mat::eye(4, 4, CV_64FC1);
  SE3_2 = Mat::eye(4, 4, CV_64FC1);

  typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::Image, sensor_msgs::Image> SyncPolicy;
  message_filters::Synchronizer<SyncPolicy> sync(SyncPolicy(10), sub_img_left, sub_img_right);
  sync.registerCallback(boost::bind(&imgCallback, _1, _2,SE3_1));

  //cam 2.
  //typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::Image, sensor_msgs::Image> SyncPolicy;
  //message_filters::Synchronizer<SyncPolicy> sync(SyncPolicy(10), sub_img_left, sub_img_right);
  //sync.registerCallback(boost::bind(&imgCallback, _1, _2,TODO....));
