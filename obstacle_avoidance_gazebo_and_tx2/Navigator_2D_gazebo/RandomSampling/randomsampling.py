...
class randomsampling:
    ...
    def find_path(self, pose_d, target_pose_d, obstacle_3d):
        ...
        t2 = time.time()
        print("time taken for get_obstacle_at_neighbor_height: ", t2-t1)
    ...
    current body coordinate frame used in Gazebo:
    ...
    def random_samples(self, number=200):
        ...
        for sample in samples:
            idss = list(self.obstacle_kdtree.query_radius(np.array([sample[0], sample[1]]).reshape(1, -1), r=7))[0]
