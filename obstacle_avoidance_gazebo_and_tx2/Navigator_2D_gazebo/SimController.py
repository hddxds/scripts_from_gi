...
class Controller:
    ...
    def mav_move(self, x, y, z, yaw=None, abs_mode=True):
        ...
        # convert pose from ROS frame to ENU frame (defined in commander where x points to EAST, y points to NORTH and z upwards)
        x, y, z = self.nwu2enu(x, y, z)
